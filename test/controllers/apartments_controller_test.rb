...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { apartmentName: @apartment.apartmentName, locationID: @apartment.locationID, numberOfRooms: @apartment.numberOfRooms } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { apartmentName: @apartment.apartmentName, locationID: @apartment.locationID, numberOfRooms: @apartment.numberOfRooms } }

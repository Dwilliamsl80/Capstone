...
class RentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create renter" do
    assert_difference('Renter.count') do
      post renters_url, params: { renter: { firstName: @renter.firstName, lastName: @renter.lastName, roomID: @renter.roomID } }
    end
  ...
  test "should update renter" do
    patch renter_url(@renter), params: { renter: { firstName: @renter.firstName, lastName: @renter.lastName, roomID: @renter.roomID } }
